...
#read html file
filename <- "E:/Data Science/Google data Prateek January 2018/datasmall/Takeout/My Activity/Search/big.html"
inputdata <- read_html(filename)
...
a <- top_terms_by_topic_LDA(data$event.query.query_text, number_of_topics = 2, plot= T)
print(a)
